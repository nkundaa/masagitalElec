export interface Product {
  id: string;
  name: string;
  category: 'sensors' | 'microcontrollers' | 'iot' | 'actuators';
  price: number;
...
export const products: Product[] = [
  // SENSORS
  {
    ...
    shortDescription: 'High precision digital temperature and humidity sensor module.',
    ...
    youtubeVideoId: 'OogldSc9uMg',
    tutorialTitle: 'DHT22 Sensor with Arduino - Complete Tutorial',
    inStock: true,
    rating: 4.7,
    reviews: 128,
    badge: 'Best Seller'
  },
  {
    ...
    shortDescription: 'Accurate non-contact distance measurement from 2cm to 400cm.',
    ...
    tutorialTitle: 'HC-SR04 Ultrasonic Sensor Arduino Tutorial',
    inStock: true,
    rating: 4.5,
    reviews: 95
  },
  {
    ...
    shortDescription: '6-axis motion tracking sensor with built-in DMP.',
    ...
    youtubeVideoId: 'wTfSfhjhAU0',
    tutorialTitle: 'MPU-6050 Gyroscope + Accelerometer Arduino Tutorial',
    inStock: true,
    rating: 4.8,
    reviews: 73,
    badge: 'Popular'
  },
  {
    ...
    shortDescription: 'Passive infrared motion detection for security and automation.',
    ...
    youtubeVideoId: '6Fdrr_1WLEY',
    tutorialTitle: 'PIR Motion Sensor with Arduino - Beginner Tutorial',
    inStock: true,
    rating: 4.4,
    reviews: 61
  },
  ...
  // MICROCONTROLLERS
  {
    ...
    originalPrice: 15000,
    image: 'https://images.pexels.com/photos/343457/pexels-photo-343457.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'The most popular microcontroller board for beginners and experts.',
    ...
    tutorialTitle: 'Arduino Uno for Beginners - Complete Getting Started Guide',
    inStock: true,
    rating: 4.9,
    reviews: 215,
    badge: 'Top Rated'
  },
  {
    ...
    price: 8000,
    image: 'https://images.pexels.com/photos/14887613/pexels-photo-14887613.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'Powerful dual-core MCU with built-in WiFi and Bluetooth.',
    ...
    youtubeVideoId: 'xPlN_Tk3VLQ',
    tutorialTitle: 'Getting Started with ESP32 - WiFi & Bluetooth Tutorial',
    inStock: true,
    rating: 4.8,
    reviews: 187,
    badge: 'Best for IoT'
  },
  {
    ...
    originalPrice: 12000,
    image: 'https://images.pexels.com/photos/4549831/pexels-photo-4549831.png?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'Compact microcontroller with WiFi, powered by RP2040 chip.',
    ...
    youtubeVideoId: 'JucQb4DKHOQ',
    tutorialTitle: 'Raspberry Pi Pico W Getting Started Guide',
    inStock: true,
    rating: 4.7,
    reviews: 142
  },
  {
    ...
    shortDescription: '32-bit ARM Cortex-M3 development board, Arduino compatible.',
    ...
    howItWorks: [
      ...
      'Write your Arduino code using familiar syntax.',
      'Click Upload to flash the firmware via ST-Link.',
      'Alternatively, use the USB bootloader for cable-free programming.'
    ],
    youtubeVideoId: 'JnEMdqqEFMk',
    tutorialTitle: 'STM32 Blue Pill Programming with Arduino IDE',
    inStock: true,
    rating: 4.5,
    reviews: 89
  },
  ...
  // IOT SYSTEMS
  {
    ...
    originalPrice: 6500,
    image: 'https://images.pexels.com/photos/343457/pexels-photo-343457.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'WiFi-enabled IoT development board with Lua/Arduino support.',
    ...
    youtubeVideoId: 'G6CqvhXpBKM',
    tutorialTitle: 'NodeMCU ESP8266 IoT Tutorial - Web Server & Sensors',
    inStock: true,
    rating: 4.6,
    reviews: 167,
    badge: 'Hot Deal'
  },
  {
    ...
    price: 7500,
    image: 'https://images.pexels.com/photos/14887613/pexels-photo-14887613.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'Long-range wireless communication up to 10km for IoT networks.',
    ...
    youtubeVideoId: '_e_0MYGpYgI',
    tutorialTitle: 'LoRa Long Range IoT Communication Tutorial',
    inStock: true,
    rating: 4.6,
    reviews: 54
  },
  {
    ...
    price: 6000,
    image: 'https://images.pexels.com/photos/4549831/pexels-photo-4549831.png?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    shortDescription: 'Cellular connectivity module for SMS, calls, and GPRS data.',
    ...
    youtubeVideoId: 'S_mDLfEJeRw',
    tutorialTitle: 'SIM800L GSM Module - Send SMS & Make Calls with Arduino',
    inStock: true,
    rating: 4.3,
    reviews: 98
  },
  {
    ...
    shortDescription: 'Control 4 appliances remotely via WiFi with smartphone app.',
    ...
    youtubeVideoId: 'BtLwoNJ6klE',
    tutorialTitle: 'Smart WiFi Relay - Home Automation Setup Guide',
    inStock: true,
    rating: 4.5,
    reviews: 76,
    badge: 'Smart Home'
  ...
  // ACTUATORS
  {
    ...
    shortDescription: 'Lightweight 9g servo motor with 180° rotation for robotics.',
    ...
    youtubeVideoId: 'kUHmYKWwuWs',
    tutorialTitle: 'SG90 Servo Motor with Arduino - Complete Guide',
    inStock: true,
    rating: 4.6,
    reviews: 143
  },
  {
    ...
    shortDescription: 'Precision stepper motor kit with driver board for accurate positioning.',
    ...
    youtubeVideoId: 'CEz1EeDlpbs',
    tutorialTitle: '28BYJ-48 Stepper Motor Arduino Tutorial',
    inStock: true,
    rating: 4.5,
    reviews: 87,
    badge: 'Kit Included'
  },
  {
    ...
    shortDescription: 'Dual H-Bridge motor driver for controlling 2 DC motors or 1 stepper.',
    ...
    youtubeVideoId: 'dyjo_ggEtVU',
    tutorialTitle: 'L298N Motor Driver with Arduino - DC Motor Control',
    inStock: true,
    rating: 4.7,
    reviews: 112
  },
  {
    ...
    shortDescription: 'Control high-voltage appliances safely with Arduino.',
    ...
    youtubeVideoId: 'dOEyzOLjsJQ',
    tutorialTitle: 'Relay Module with Arduino - Control AC Appliances Safely',
    inStock: true,
    rating: 4.4,
    reviews: 95
  }
...
export const categories = [
  ...
  { id: 'sensors', name: 'Sensors', icon: '📡', count: products.filter(p => p.category === 'sensors').length },
  { id: 'microcontrollers', name: 'Microcontrollers', icon: '🔌', count: products.filter(p => p.category === 'microcontrollers').length },
  { id: 'iot', name: 'IoT Systems', icon: '🌐', count: products.filter(p => p.category === 'iot').length },
  { id: 'actuators', name: 'Actuators', icon: '⚙️', count: products.filter(p => p.category === 'actuators').length },
];
